...
def validar():
    ...
    arqs = ['URI1_6x9p.txt', 'URI1_1x8p.txt', 'URI1_1x1p.txt', 'URI2_1x1p.txt', 'URI1_80x80p.txt', 'URI2_80x80p.txt', 'URI1_1024x1024p.txt', 'URI2_1024x1024p.txt', 'URI3_1024x1024p.txt', 'URI3_1024x1024p.txt']
    for arq in arqs:
        lerArquivo(arq)
